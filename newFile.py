        ...
        for root, dirs, files in os.walk(self.photo_directory):
            ...
            for filename in files:
                ...
                if filename.lower().endswith('.pdf'):
                    ...
                    # self.convert_pdf_to_images(filepath, self.mirror_directory)
                elif filename.lower().endswith('.jpg'):
                    # Копируем jpg-файлы в зеркальную структуру с сохранением иерархии
                    mirror_filepath = os.path.join(self.mirror_directory, os.path.relpath(filepath, self.photo_directory))
    ...
    def resize_photo(self, filepath, quality_reduction=10):
        with Image.open(filepath) as img:
            ...
            while os.path.getsize(filepath) > 700 * 1024:
                new_filepath = os.path.join(self.resized_photo_directory, os.path.relpath(filepath, self.photo_directory))
